 ...
 */
final class Version20220307125320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD lat VARCHAR(255) DEFAULT NULL, ADD lng VARCHAR(255) DEFAULT NULL');
    }
